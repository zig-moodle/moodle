...
class report_loglive_table_log extends table_sql {
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        if (!empty($this->filterparams->courseid)) {
            ...
            // Get course module contexts that need to be filtered from loglive reporting.
            $contextids = $this->get_course_module_contexts_to_hide_associated_loglive_events($courseid);
     ...
     * in the event loglive report.
     *
     * @param   int $courseid The course ID.
     * @return  array of context id values.
     */
    protected function get_course_module_contexts_to_hide_associated_loglive_events($courseid) {
        $contextids = [];
