...
/**
 * Callback function 'get_contexts_to_hide_associated_event_logs()' that returns an array of contextid values of
 * assignments with blindmarking enabled for the specified course to exclude in event log reports and loglive reports.
 *
 ...
 * @return  array
 */
function mod_assign_get_contexts_to_hide_associated_event_logs($courseid) {
    global $CFG, $USER;
