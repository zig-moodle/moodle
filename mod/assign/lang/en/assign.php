...
$string['gradetopassnotset'] = 'This assignment does not have a grade to pass set so you cannot use this option. Please set the require grade setting first.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be less than zero as this assignment has its completion method set to require passing grade. Please set a positive numeric value.';
