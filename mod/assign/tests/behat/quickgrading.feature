...
Feature: In an assignment, teachers grade multiple students on one page
  ...
  Scenario: Grade multiple students on one page with unlimited grades enabled and gradepointmax set to 200
    Given the following "courses" exist:
      | fullname | shortname | category | groupmode |
      | Course 1 | C1 | 0 | 1 |
    And the following "users" exist:
    ...
    And I click on "Grade" "link" in the "Student 1" "table_row"
    And I set the following fields to these values:
      | Grade out of 100 | 60.0 |
      | Feedback comments | Teacher first feedback for Student 1 |
    And I press "Save changes"
    And I press "Ok"
    ...
    And I set the following fields to these values:
      | Grade out of 100 | 160.0 |
      | Feedback comments | Teacher first feedback for Student 2 |
    And I press "Save changes"
    And I press "Ok"
    And I follow "Assignment: Test assignment name"
    And I navigate to "View all submissions" in current page administration
    ...
    And I set the following fields to these values:
      | Grade out of 100 | 260.0 |
      | Feedback comments | Teacher first feedback for Student 3 |
    And I press "Save changes"
    And I should see "Unlimited grade must be less than or equal to the grade point maximum"
    And I follow "Assignment: Test assignment name"
    And I navigate to "View all submissions" in current page administration
    Then I click on "Quick grading" "checkbox"
    And I click on "User grade" "field" in the "Student 1" "table_row"
    And I set the field "User grade" to "60.0"
    And I click on "User grade" "field" in the "Student 2" "table_row"
    And I set the field "User grade" to "160.0"
    And I click on "User grade" "field" in the "Student 3" "table_row"
    And I set the field "User grade" to "260.0"
    And I press "Save all quick grading changes"
    And I should see "The grade changes were saved"
    And I press "Continue"
    And I log out
    ...
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    And I should see "Teacher first feedback for Student 1"
    And I should see "60.0"
    And I follow "Grades" in the user menu
    And I click on "Course 1" "link" in the "region-main" "region"
    And I log out
    ...
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    And I should see "Teacher first feedback for Student 2"
    ...
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    And I should not see "Teacher first feedback for Student 3"
    And I should not see "260.0"
    And I follow "Grades" in the user menu
    And I click on "Course 1" "link" in the "region-main" "region"
    And I log out
    And I log in as "teacher1"
