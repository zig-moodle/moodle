...
class mod_assign_lib_testcase extends advanced_testcase {
     ...
     */
    public function test_mod_assign_get_excluded_context_ids_for_course_with_viewblinddetails() {
        $this->resetAfterTest();
        ...
        $contexts = mod_assign_get_excluded_context_ids_for_course($course->id);
        ...
        $excludedcontexts = mod_assign_get_excluded_context_ids_for_course($course->id);
