 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements \core_privacy\metadata\provider, \core_privacy\request\plugin\subplugin_provider {
    /**
     * @return array The array of metadata.
     */
    public static function get_metadata(\core_privacy\metadata\collection $collection)
        : \core_privacy\metadata\collection {
